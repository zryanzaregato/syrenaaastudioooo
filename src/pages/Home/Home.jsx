...
export default function Home() {
  ...
  return (
    <PageTransition>
      {/* ═══════════════════════ FIXED BACKGROUND FULL-PAGE VIDEO ═══════════════════════ */}
      <BackgroundVideo src="/364463.mp4" />
        ...
        <div className={`container ${styles.heroContent}`}>
          <div className={styles.heroInner}>
            ...
            <p className={styles.heroDesc}>
              Syrena partners with category-defining brands to fuse cinematic visual craft, data science, and high-velocity digital marketing into an unfair competitive advantage.
            </p>
